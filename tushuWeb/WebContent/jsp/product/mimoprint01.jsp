				...
				<div id="upload_flash" class="upload_item_show">
					<div class="zip_uploader">
						<object width="900" height="536" align="middle"
							...
							<param name="productId" value="${product.productId}">
							...
							value="uploadUrl=<%=path%>/user/${sessionUserName.id}/uploadImages.html">
